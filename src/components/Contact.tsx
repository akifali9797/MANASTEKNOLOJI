      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mb-12 sm:mb-16">
          <a
            ...
            className="group relative inline-flex items-center gap-2.5 bg-green-500 hover:bg-green-600 text-white font-bold px-6 py-3.5 sm:px-10 sm:py-5 rounded-xl sm:rounded-2xl transition-all duration-300 hover:shadow-2xl hover:shadow-green-500/30 hover:-translate-y-1 text-base sm:text-lg animate-glow"
          >
        ...
        <div className="grid gap-4 sm:grid-cols-3 sm:gap-6">
          ...
          >
            ...
            <div className="relative flex items-start gap-3 sm:block sm:text-center">
              ...
              <div className="min-w-0 text-left sm:text-center">
                <h3 className="text-white font-bold text-sm mb-1 sm:mb-2">Telefon</h3>
          ...
          >
            ...
            <div className="relative flex items-start gap-3 sm:block sm:text-center">
              ...
              <div className="min-w-0 text-left sm:text-center">
                <h3 className="text-white font-bold text-sm mb-1 sm:mb-2">E-posta</h3>
                <span className="text-brand-gray text-sm hover:text-brand-red transition-colors break-all sm:break-normal">
          ...
          >
            ...
            <div className="relative flex items-start gap-3 sm:block sm:text-center">
              ...
              <div className="min-w-0 text-left sm:text-center">
                <h3 className="text-white font-bold text-sm mb-1 sm:mb-2">Adres</h3>
